...
def build_pdf():
    ...
    table_row_3(pdf, col_pay, ["PayPal 10回分割払い", "243,000円", "① 入学金 90,000 ／ ②〜⑩ 17,000"])
    pdf.ln(4)
    set_regular(pdf, 9)
    pdf.set_text_color(120, 120, 120)
    pdf.cell(0, 5, "※ 243,000円組：①90,000＋②〜⑩17,000×9。①10万＋②27,000×9は343,000円（先生コース）", new_x="LMARGIN", new_y="NEXT")
    pdf.ln(3)
