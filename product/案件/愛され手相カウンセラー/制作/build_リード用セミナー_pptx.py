#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Marp Markdown → PPTX（リード用セミナー）。依存: python-pptx（_pptx_vendor 参照）"""
...
MD_PATH = CASE_ROOT / "ライティング" / "リード用セミナー_60分_スライド.md"
OUT_PATH = CASE_ROOT / "スライド" / "リード用セミナー_60分_スライド.pptx"
